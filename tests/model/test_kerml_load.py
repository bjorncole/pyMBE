...
def test_memberships_load(basic_load_files):
    ...
    level1_membs = [memb for memb in list(level1.elements.values())
    ...
    level1_memb_names = [(memb.owningRelatedElement.declaredName, memb.ownedRelatedElement[0].declaredName) for memb in level1_membs_single
...
def test_invariant_load(basic_load_files):
    ...
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[0].\
        ownedRelatedElement[0].ownedRelationship[0]._metatype == "FeatureValue"
    
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[0].\
        ownedRelatedElement[0].ownedRelationship[0].ownedRelatedElement[0].\
        ownedRelationship[0].memberElement.declaredName == "Register 1"
    
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[1].\
    ...
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[1].\
        ...
        ownedRelatedElement[0].ownedRelationship[0].memberElement.declaredName == "Register 2"
    
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[1].\
        ownedRelatedElement[0].ownedRelationship[0].ownedRelatedElement[0].\
        ownedRelationship[1].ownedRelatedElement[0].ownedRelationship[0].\
        ownedRelatedElement[0].ownedRelationship[0].memberElement.declaredName == "Register 3"
    ...
    assert key_invar.ownedRelationship[0].ownedRelatedElement[0].ownedRelationship[1].\
        ...
        memberElement.declaredName == "Register 3"